...
def criar_post():
    ...
    if form.validate_on_submit():
        ...
        database.session.commit()
        flash('Post Criado com Sucessp', 'alert-success')
        return  redirect(url_for('home'))
...
def salvar_imagem(imagem):
    ...
    # salvar a imagem na pasra foto_perfil
    # mudar o campo foto_perfil do uduario para o novo nome da imagem.
